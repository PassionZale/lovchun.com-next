...
- [代码仓库](https://github.com/PassionZale/geist-design-icons)
- [在线预览](https://geist-design.lovchun.com/components/icons.html)
...
<Tree data={SvgIconStructure} />

export const SvgIconStructure = [
  {
    type: 'folder',
    name: 'src',
    expand: true,
...
export const BuildStructure = [
  {
    ...
    childrens: [
      ...
      {
        type: 'file',
        name: 'geist-design-icons.es.js',
        icon: 'js'
      },
      {
        type: 'file',
        name: 'geist-design-icons.umd.js',
        icon: 'js'
      },
      {
        type: 'file',
