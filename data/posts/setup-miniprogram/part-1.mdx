---
title: 'Setup Miniprgram - 插件、目录、开发者工具、配置'
...
> - :rainbow: [《Setup Miniprgram - 插件、目录、开发者工具、配置》](/posts/setup-miniprogram/part-1)
>
...
>
> - [《Setup Miniprgram - Page Component Generator》](/posts/setup-miniprogram/part-4)
>
