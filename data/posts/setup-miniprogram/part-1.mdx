---
title: 'Setup Miniprgram - 插件、目录结构、开发者工具、配置、Packages'
...
> - :rainbow: [《Setup Miniprgram - 插件、目录结构、开发者工具、配置、Packages》](/posts/setup-miniprogram/part-1)
>
...
>   - 异常、通讯、技巧
>
> - [《Setup Miniprgram - Gulp Tasks》](/posts/setup-miniprogram/part-3)
>
>   - Gulp Tasks
>
